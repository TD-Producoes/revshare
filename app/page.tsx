          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="max-w-2xl space-y-8">
              ...
              <p className="max-w-xl text-lg text-muted-foreground leading-relaxed">
                The first marketplace that connects high-quality SaaS products
                with expert marketers. Makers build. Marketers sell. Everyone
                wins.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Button
                  size="lg"
                  className="h-12 rounded-full px-8 text-base shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/20 transition-all"
                  asChild
                >
                  <Link href="/signup">
                    Get started
                ...
                <Button
                  size="lg"
                  variant="ghost"
                  className="h-12 rounded-full px-8 text-base hover:bg-primary/5"
                  asChild
                >
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground pt-4">
                ...
                <span>
                  Creators only pay on successful sales. No monthly fees.
                </span>
              </div>
            </div>
              ...
              <Card className="relative overflow-hidden border-border/50 bg-background/60 shadow-2xl backdrop-blur-xl">
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant="outline"
                      className="border-emerald-500/20 bg-emerald-500/10 text-emerald-500 text-[10px]"
                    >
                      <Zap className="mr-1 h-3 w-3" /> AUTOMATED
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="rounded-lg bg-muted/30 border border-border/40 p-3 flex items-center gap-3 justify-center">
                    ...
                    <span className="text-xs text-muted-foreground font-medium">
                      Funds routed automatically via Stripe Connect
                    </span>
                  </div>
                </CardContent>
              </Card>
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground">
                              ...
                              <span className="truncate">
                                {marketer.activeProjects} projects
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              <CardContent className="p-0 flex flex-col flex-1">
                ...
                <div className="divide-y divide-border/40 flex-1">
                  {isLoadingProjects ? (
                    ...
                    topProjects.map(
                      (project: (typeof topProjects)[0], i: number) => (
                        <Link
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 max-w-2xl text-center mx-auto">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl mb-4">
              ...
              <span className="text-primary">scale revenue</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              A complete toolkit for managing partnerships, payouts, and
              performance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex-1 p-4 min-h-0 flex flex-col justify-end">
                <div className="relative w-full h-32 bg-muted/10 rounded-lg border border-border/40 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 right-3 flex gap-2">
                    <div className="h-6 w-16 bg-orange-500/10 rounded border border-orange-500/20 flex items-center justify-center text-[10px] text-orange-500 font-medium">
                      Sign
                    </div>
                  </div>
                </div>
            ...
            <Card className="overflow-hidden border-border/50 bg-background/50 backdrop-blur-sm group hover:border-primary/50 transition-colors h-[280px] flex flex-col">
              ...
              <div className="flex-1 p-4 min-h-0 flex items-end">
                <div className="w-full border-2 border-dashed border-pink-500/30 bg-pink-500/5 rounded-lg p-3 flex flex-col items-center justify-center gap-1 group-hover:border-pink-500/50 transition-colors">
                  ...
                  <span className="font-mono text-lg font-bold text-pink-500 tracking-wider">
                    BMK20
                  </span>
                </div>
              </div>
            ...
            <Card className="overflow-hidden border-border/50 bg-background/50 backdrop-blur-sm group hover:border-primary/50 transition-colors h-[280px] flex flex-col">
              <CardHeader className="pb-2">
                ...
                <CardDescription>Showcase best performers.</CardDescription>
              </CardHeader>
            ...
            <Card className="overflow-hidden border-border/50 bg-background/50 backdrop-blur-sm group hover:border-primary/50 transition-colors h-[280px] flex flex-col">
              <CardHeader className="pb-2">
                ...
                <CardDescription>Live maker & marketer stats.</CardDescription>
              </CardHeader>
              <div className="flex-1 p-4 pt-2 flex flex-col gap-3 min-h-0 justify-end">
                ...
                <div className="rounded-md bg-emerald-500/10 p-2.5 border border-emerald-500/20">
                  <div className="text-[10px] text-emerald-600/80 uppercase mb-0.5">
                    My Earnings
                  </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                We built RevShare on top of Stripe Connect to ensure money flows
                directly between verified parties. We never hold your funds.
              </p>
              ...
              <div className="relative rounded-2xl border border-border/60 bg-background/50 backdrop-blur-xl p-8 shadow-2xl">
                <div className="space-y-6">
                  <div className="flex items-center gap-4 border-b border-border/40 pb-6">
                    <div className="h-10 w-10 bg-[#635BFF] rounded-lg flex items-center justify-center text-white font-bold">
                      S
                    </div>
                    <div>
        ...
        <div className="relative flex w-full overflow-hidden">
          ...
          <div className="flex w-full animate-in fade-in zoom-in duration-1000 justify-center gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all">
            ...
            {[
              ...
              <div
                key={brand}
                className="text-xl font-bold tracking-tight text-foreground/40 hover:text-foreground/80 cursor-default"
              >
                {brand}
              </div>
            ))}
          ...
          <div className="rounded-3xl bg-gradient-to-tr from-muted/50 via-background to-muted/50 p-1 border border-border/40">
            <div className="rounded-[1.4rem] bg-background p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
              <div className="space-y-4 max-w-2xl">
                ...
                <p className="text-lg text-muted-foreground">
                  Join the network where top creators and elite marketers build
                  wealth together.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 shrink-0">
                <Button
                  size="lg"
                  className="rounded-full px-8 h-12 text-base shadow-lg shadow-primary/10"
                  asChild
                >
                  <Link href="/signup">
                    Create workspace
