...
function buildMarkdown(): string {
  ...
  const bodyLines = [
    ...
    "",
    "Project payload rule (important):",
    "- `country` must be an **ISO 3166-1 alpha-2** code (uppercase), same as the web app project form.",
    "- Examples: `US`, `PT`, `GB`, `BR`.",
    "- Do not send full country names like `United States` or `Portugal`.",
    "",
    "### Applications",
