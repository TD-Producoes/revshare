...
function buildMarkdown(): string {
  ...
  const frontmatterLines = [
    ...
    `auth_instructions_url: ${CANONICAL_ORIGIN}/revclaw/auth.md`,
    ...
    "  - stripe:connect_link",
    "approval_required:",
    "  projects:publish: true",
    "  applications:submit: true",
    "  stripe:connect_link: false",
    "  projects:draft_write: false",
    "  applications:draft_write: false",
  ...
  const bodyLines = [
    ...
    "# RevClaw Skills (v0)",
    "",
    "This document is the **public, canonical** skill declaration for RevClaw clients (e.g. OpenClaw/Clawdbot).",
    "",
    "- **No secrets** are ever published here.",
    "- This is a *declaration*, not an authorization grant.",
    "",
    "## API base",
    "",
